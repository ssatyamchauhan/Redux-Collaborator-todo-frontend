...
class Listofproject extends React.Component {
   ...
   logout = () => {
    ...
    componentDidMount () {
        axios.get('http://13.126.45.215:2000/project', {params: {token:ls.get('credentials')}})
        .then(data => {
            console.log('this is the data of project', data.data)
...
const mapStateToProps = (state) => {
    console.log(state.listofproject)
    return {
